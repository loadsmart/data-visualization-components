...
export default {
  ...
  argTypes: {
    ...
    titleChildren: {control: 'text', name: 'Title', table: {category: 'Content'}},
    contentChildren: {control: 'text', name: 'Content', table: {category: 'Content'}},
    contentEditStartButtonContent: {control: 'text', name: 'Edit Button Content', table: {category: 'Content'}},
    contentEditEndButtonContent: {control: 'text', name: 'Edit Save Button Content', table: {category: 'Content'}},
    contentEditable: {control: 'boolean', name: 'Editable?', table: {category: 'Functionality'}},
    contentEditing: {control: 'boolean', name: 'Currently editing?', table: {category: 'Functionality'}},
    background: {control: 'color', name: 'Background (theme.card.background)', table: {category: 'Card Theme'}},
    padding: {
      control: {
        type: 'range',
        min: 0, max: 50, step: 1
      }, name: 'Padding (theme.card.padding)', table: {category: 'Card Theme'}
    },
    shadowColor: {control: 'color', name: 'Shadow Color (theme.card.shadow)', table: {category: 'Card Theme'}},
    shadowHOffset: {
      control: {
        type: 'range',
        min: 0, max: 50, step: 1
      }, name: 'Shadow H Offset (theme.card.shadow)', table: {category: 'Card Theme'}
    },
    shadowVOffset: {
      control: {
        type: 'range',
        min: 0, max: 50, step: 1
      }, name: 'Shadow V Offset (theme.card.shadow)', table: {category: 'Card Theme'}
    },
    shadowBlur: {
      control: {
        type: 'range',
        min: 0, max: 50, step: 1
      }, name: 'Shadow Blur (theme.card.shadow)', table: {category: 'Card Theme'}
    },
    shadowSpread: {
      control: {
        type: 'range',
        min: 0, max: 50, step: 1
      }, name: 'Shadow Spread (theme.card.shadow)', table: {category: 'Card Theme'}
    },
    borderRadius: {
      control: {
        type: 'range',
        min: 0, max: 50, step: 1
      }, name: 'Border Radius [px] (theme.card.border.radius)', table: {category: 'Card Theme'}
    },
    titleSize: {
      control: {
        type: 'range',
        min: 0, max: 50, step: 1
      }, name: 'Title Font Size [px] (theme.card.title.size)', table: {category: 'Card Theme'}
    },
    titleWeight: {
      control: {
        type: 'range',
        min: 100, max: 900, step: 100
      }, name: 'Title Font Weight [px] (theme.card.title.weight)', table: {category: 'Card Theme'}
    },
    titleColor: {control: 'color', name: 'Title Text Color (theme.card.title.color)', table: {category: 'Card Theme'}},
    contentSize: {
      control: {
        type: 'range',
        min: 0, max: 50, step: 1
      }, name: 'Title Text Color (theme.card.title.color)', table: {category: 'Card Theme'}
    },
    contentWeight: {
      control: {
        type: 'range',
        min: 100, max: 900, step: 100
      }, name: 'Content Font Weight [px] (theme.card.content.weight)', table: {category: 'Card Theme'}
    },
    contentColor: {
      control: 'color',
    ...
    contentMargin: {
      control: {
        type: 'range',
        min: 0, max: 50, step: 1
      }, name: 'Content Margin [px] (theme.card.content.margin)', table: {category: 'Card Theme'}
    },
    contentEditButtonPadding: {
      ...
      name: 'Content Edit Button Padding [px] (theme.card.content.editButton.padding)',
      table: {category: 'Card Theme'}
    },
    ...
    contentEditButtonBorderRadius: {
      ...
      name: 'Edit Button Border Radius [px] (theme.card.content.editButton.border.radius)',
      table: {category: 'Card Theme'}
    },
    contentEditButtonBorderWidth: {
      ...
      name: 'Edit Button Border Width [px] (theme.card.content.editButton.border.width)',
      table: {category: 'Card Theme'}
    },
    contentEditButtonWidth: {
      control: {
        type: 'range',
        min: 0, max: 50, step: 1
      }, name: 'Edit Button Width [px] (theme.card.content.editButton.width)', table: {category: 'Card Theme'}
    },
    contentEditButtonHeight: {
      control: {
        type: 'range',
        min: 0, max: 50, step: 1
      }, name: 'Edit Button Height [px] (theme.card.content.editButton.height)', table: {category: 'Card Theme'}
    },
    contentEditButtonRight: {
      control: {
        type: 'range',
        min: 0, max: 50, step: 1
      }, name: 'Edit Button Distance from Left (theme.card.content.editButton.left)', table: {category: 'Card Theme'}
    },
    contentEditButtonTop: {
      control: {
        type: 'range',
        min: 0, max: 50, step: 1
      }, name: 'Edit Button Distance from Top (theme.card.content.editButton.top)', table: {category: 'Card Theme'}
    },
...
DefaultThemeCard.args = {
  titleChildren: 'This button has the default style, but you can still configure contents and functionality below.',
  contentChildren: 'The theme props will be ignored for storybook purposes, in reality you can provide as much theme customization as you want, and whatever you don\'t provide will fallback to the default theme',
